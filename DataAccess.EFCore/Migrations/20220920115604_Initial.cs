        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CandidiatePhoneNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CandidateGender = table.Column<string>(type: "nvarchar(1)", nullable: false),
                    PreferedLanguageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Candidates", x => x.CandidateId);
                    table.ForeignKey(
                        name: "FK_Candidates_Languages_PreferedLanguageId",
                        column: x => x.PreferedLanguageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Candidates_PreferedLanguageId",
                table: "Candidates",
